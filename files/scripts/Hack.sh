...
# wallpaper ---------------------------------
set_wallpaper() {
	nitrogen --save --set-zoom-fill /usr/share/backgrounds/amos-wallpapers"$1"
}
...
# changing conky color
wal -i /usr/share/backgrounds/hack.jpg
...
obconfig 'Hack' 'LC' 'JetBrains Mono' '9' 'menu-glyphs.xml' && openbox --reconfigure
