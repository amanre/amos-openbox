...
# wallpaper ---------------------------------
set_wallpaper() {
	nitrogen --save --set-zoom-fill /usr/share/backgrounds/amos-wallpaper-v2"$1"
}
...
change_appearance 'Amos-Cyberpunk-Teel' 'arcolinux-candy-beauty' 'Bibata-Rainbow-Modern' 'Noto Sans 9'

# funct THEME LAYOUT FONT SIZE (Change margin in funct)
obconfig 'Amos-Cyberpunk-Teel' 'MLC' 'JetBrains Mono' '9' 'menu-glyphs.xml' && openbox --reconfigure
...
# Change Conky Coloring
wal -i /usr/share/backgrounds/amos-wallpaper-v2/74.jpg
