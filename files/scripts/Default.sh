...
change_appearance 'Windows-10-Dark' 'Zafiro' 'Qogirr' 'Noto Sans 9'

# funct THEME LAYOUT FONT SIZE (Change margin in funct)
obconfig 'Windows-10-Dark' 'DLIMC' 'JetBrains Mono' '9' 'menu-glyphs.xml' && openbox --reconfigure
...
# Change Conky color_scheme
wal -i /usr/share/backgrounds/default.jpg
