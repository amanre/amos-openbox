...
# Change Conky Colors
wal -i /usr/share/backgrounds/amos-wallpaper-v2/31.jpg
...
change_appearance 'Arc-Dark' 'Arc-Circle' 'Bibata-Raibow-Modern' 'Noto Sans 9'

# funct THEME LAYOUT FONT SIZE (Change margin in funct)
obconfig 'Arc-Dark' 'CLM' 'JetBrains Mono' '9' 'menu-glyphs.xml' && openbox --reconfigure
