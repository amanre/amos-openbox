# Maintainer: Achim Reiz <amanre556@gmail.com>

pkgname=amos-openbox
pkgver=1.0
pkgrel=1
pkgdesc="Openbox WM Configurations for Amos"
url="https://github.com/amanre/amos-openbox"
arch=('any')
license=('GPL3')
makedepends=()
depends=('amos-skeleton')
conflicts=()
provides=("${pkgname}")
...
package() {
	local _sharedir=${pkgdir}/usr/share/amos/openbox
